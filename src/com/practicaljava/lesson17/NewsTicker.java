...
public class NewsTicker {
    ...
    private void displayGUI() {
        ...
        button.addActionListener( event ->{
		    new NewsReader(new File("src/com/practicaljava/lesson17/news.txt"), 
					   textAreaLeft, leftProgressBar).execute();
			new NewsReader(new File("src/com/practicaljava/lesson17/hearthstone.txt"), 
