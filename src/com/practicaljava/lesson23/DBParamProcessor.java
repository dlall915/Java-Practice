...
public class DBParamProcessor {
	public static void main(String[] args) {
		if (args.length == 0) {
			System.out.println("Provide the name of the annotated class as a "
					+ "command-line argument.");
			System.out.println("For example, java DBParamProcessor "
					+ "tryit.MyDBWorker");
			System.exit(1);
		}
		...
		try {
			...
			DBParam dbParamAnnotation = 
					(DBParam) classForIntrospection.getAnnotation(DBParam.class);
