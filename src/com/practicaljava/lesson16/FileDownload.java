...
class FileDownload {
	public static void main (String[] args) {
		if (args.length != 2) {
			System.out.println("Proper Usage: java FileDownload SourceFile URL "
					+ "OutputFileName");
			System.out.println("For example: java FileDownload "
					+ "http://http://myflex.org/yf/nyc.jpg nyc.jpg");
			System.exit(-1);
		}
